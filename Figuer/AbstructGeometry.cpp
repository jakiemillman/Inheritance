...
#define SHAPE_GIVE_PARAMETERS start_x, start_y, line_width, color
	...
	public:
		...
		void draw()const
		{
			...
			POINT vertex[] =
			{
				{start_x, start_y + side2},			//vertex_1
				{start_x + side2, start_y + side2},	//vertex_2
				{start_x + side1 / 2, start_y + side1 - get_height()}	//vertex_3
			};
...
void main()
{
	...
	t_eq.info();
	Geometry::IsoscelesTriangle A(600, 1000, 100, 25, 15, Geometry::Color::grey);
	A.info();
}