...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------
____________________________________________________________Работа с файлами__________________________________________________________________________________________
	В С++ для работы с файлами так же как для вывода на экран и ввода с клавиатуры используются потоки. Для вводы и вывода на экран используются потоки cin и cout, а для
работы с файлами используются fin и fout. 
	cin является объектом класс istream, а cout объект класса ostream. Fin (ifstream), fout(ofstream). Единственными отличаями между консольными и файлами потоками заключается в том,
что консольные потоки уже существуют, а файловые нужно создавать.
